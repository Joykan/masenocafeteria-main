...
if (isset($_GET['delete_id'])) {
    ...
    $getImage = mysqli_query($conn, "SELECT image FROM menu_items WHERE id = $id AND category = 'Drink'");
    ...
    // Delete from DB
    $deleteQuery = "DELETE FROM menu_items WHERE id = $id AND category = 'Drink'";
...
// Fetch only "Drink" category items
$result = mysqli_query($conn, "SELECT * FROM menu_items WHERE category = 'Drink'");
?>
    ...
    <table>
        ...
        <?php while ($item = mysqli_fetch_assoc($result)) : ?>
            <tr>
                ...
                <td>
                    <a href="delete_drink.php?delete_id=<?= $item['id'] ?>" 
                       class="btn-delete" 
